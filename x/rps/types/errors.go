...
var (
	...
	ErrDuplicateGameNumber = errors.Register(ModuleName, 8, "game number already exists")
	ErrInvalidMove         = errors.Register(ModuleName, 9, "invalid move")
	ErrInvalidPlayer       = errors.Register(ModuleName, 10, "invalid player")
	ErrPlayerCantMakeMove  = errors.Register(ModuleName, 11, "player can't make move")
	ErrGameEnded           = errors.Register(ModuleName, 12, "game ended")
)
