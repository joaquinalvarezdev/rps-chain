...
export const QueryGetGameRequest: MessageFns<QueryGetGameRequest> = {
  encode(message: QueryGetGameRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetGameRequest {
...
export const QueryGetGameResponse: MessageFns<QueryGetGameResponse> = {
  encode(message: QueryGetGameResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetGameResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryGetParamsRequest: MessageFns<QueryGetParamsRequest> = {
  encode(_: QueryGetParamsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryGetParamsResponse: MessageFns<QueryGetParamsResponse> = {
  encode(message: QueryGetParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.param !== undefined) {
      Params.encode(message.param, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export class QueryClientImpl implements Query {
  ...
  GetGame(request: QueryGetGameRequest): Promise<QueryGetGameResponse> {
    ...
    return promise.then((data) => QueryGetGameResponse.decode(new BinaryReader(data)));
  }
