...
export const EventCreateGame: MessageFns<EventCreateGame> = {
  encode(message: EventCreateGame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.gameNumber.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.gameNumber.toString());
    }
    if (message.playerA !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventCreateGame {
...
export const EventEndGame: MessageFns<EventEndGame> = {
  encode(message: EventEndGame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.gameNumber.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.gameNumber.toString());
    }
    if (message.status !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventEndGame {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventMakeMove: MessageFns<EventMakeMove> = {
  encode(message: EventMakeMove, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.gameNumber.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.gameNumber.toString());
    }
    if (message.player !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventMakeMove {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EventRevealMove: MessageFns<EventRevealMove> = {
  encode(message: EventRevealMove, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.gameNumber.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.gameNumber.toString());
    }
    if (message.player !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventRevealMove {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
