...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.ttl.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.ttl.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.ttl = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const Game: MessageFns<Game> = {
  encode(message: Game, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.rounds.equals(Long.UZERO)) {
      writer.uint32(40).uint64(message.rounds.toString());
    }
    ...
    if (!message.expirationHeight.equals(Long.UZERO)) {
      writer.uint32(72).uint64(message.expirationHeight.toString());
    }
    return writer;
  },
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Game {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          if (tag === 64) {
            message.score.push(Long.fromString(reader.uint64().toString(), true));
        ...
        case 9: {
          ...
          message.expirationHeight = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
